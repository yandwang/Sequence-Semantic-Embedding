...
tf.app.flags.DEFINE_integer("src_cell_size", 512, "LSTM cell size in source RNN model.")
tf.app.flags.DEFINE_integer("tgt_cell_size", 512, "LSTM cell size in target RNN model. Same number of nodes for each model layer.")
...
tf.app.flags.DEFINE_string("device", "1", "Default to use GPU:0. Softplacement used, if no GPU found, further default to cpu:0.")
